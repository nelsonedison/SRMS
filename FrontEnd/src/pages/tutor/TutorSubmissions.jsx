...
import { ClipboardList, Search, CheckCircle, XCircle, Clock, Eye, User } from 'lucide-react';
                ...
                <div className="flex items-start justify-between mb-4">
                  <div>
                    ...
                    <div className="space-y-1">
                      ...
                      <p className="text-gray-500 text-sm">
                        <span className="font-medium">Workflow:</span> {getWorkflowDisplay(submission.form_approval_workflow)}
                      </p>
                    </div>
                  </div>
