...
import { User, Mail, Phone, Building, Crown, Calendar, Shield } from 'lucide-react';
  ...
  return (
    <div className="p-6 space-y-6 min-h-screen overflow-y-auto">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold text-gray-900">HOD Profile</h1>
          ...
          {profile && (
            <div className="space-y-6">
              ...
              <div className="text-center pb-6 border-b border-gray-200">
                ...
                <p className="text-teal-600 font-medium">Head of Department</p>
              </div>
