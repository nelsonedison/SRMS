                  ...
                  <div className="flex-1">
                      ...
                      {submission.form_approval_workflow !== 'hod_only' && (
                        <>
                          <div className={`flex items-center gap-1 px-2 py-1 rounded text-xs ${
                            submission.tutor_reviewed_at ? 'bg-green-100 text-green-700' : 'bg-orange-100 text-orange-700'
                          }`}>
                    ...
                    {(submission.tutor_comments || submission.hod_comments) && (
                      <div className="space-y-2 mb-4">
                        {submission.tutor_comments && submission.form_approval_workflow !== 'hod_only' && (
                        ...
                        {submission.hod_comments && ['hod_only', 'tutor_hod', 'tutor_hod_principal'].includes(submission.form_approval_workflow) && (
                          <div className="bg-white rounded-lg p-3">
          ...
          <table className="w-full">
            <thead>
              <tr className="border-b border-gray-200">
                ...
                <th className="text-left py-3 px-4 font-medium text-gray-600">Approval Timeline</th>
