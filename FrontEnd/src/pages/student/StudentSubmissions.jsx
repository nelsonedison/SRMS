...
import { getWorkflowDisplay, getStatusDisplay } from '../../utils/workflowUtils';
            ...
            <div className="p-6">
              <div className="flex items-start justify-between mb-4">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-4 mt-1 text-sm text-gray-500">
                      ...
                      <span>Workflow: {getWorkflowDisplay(submission.form_approval_workflow)}</span>
                    </div>
                  </div>
                </div>
                ...
                <div className={`flex items-center gap-2 px-3 py-2 rounded-lg ${getStatusColor(submission.status)}`}>
                  ...
                  <span className="font-medium">{getStatusDisplay(submission.status)}</span>
                </div>
              </div>
                ...
                <div className="flex items-center gap-4">
                  ...
                  {submission.form_approval_workflow !== 'hod_only' && (
                    <>
                      ...
                      {submission.form_approval_workflow !== 'tutor_only' && (
              ...
              {(submission.tutor_comments || submission.hod_comments || submission.principal_comments) && (
                <div className="space-y-3">
                  ...
                  {/* Show tutor comments only if workflow includes tutor */}
                  ...
                  {/* Show HOD comments if workflow includes HOD */}
                  ...
                  {/* Show principal comments only for tutor_hod_principal workflow */}
                  {submission.principal_comments && submission.form_approval_workflow === 'tutor_hod_principal' && (
                    <div className="bg-gray-50 rounded-lg p-3">
                      <div className="flex items-center gap-2 mb-1">
                        <User className="w-4 h-4 text-gray-600" />
