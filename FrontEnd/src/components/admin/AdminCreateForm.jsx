...
const CreateForm = ({ isOpen, onClose, onSuccess }) => {
  ...
  const handleClose = () => {
    setFormData({ title: '', description: '', department: '', approval_workflow: 'tutor_hod_principal', fields: [] });
    onClose();
  };
    ...
    <Modal isOpen={isOpen} onClose={handleClose} title="Create New Form" size="xl">
      <form onSubmit={handleSubmit} className="space-y-6 max-h-96 overflow-y-auto">
        ...
        <div>
          ...
          <p className="text-xs text-gray-500 mt-1">Select who needs to approve submissions for this form</p>
        </div>
