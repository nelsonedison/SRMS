...
const EditTeacher = ({ isOpen, onClose, onSuccess, teacher, departments }) => {
  ...
  const { editTeacher, loading, toast, closeToast } = useTeacher();
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await editTeacher(teacher.id, formData);
      onSuccess();
    } catch (error) {
  ...
  return (
    <Modal isOpen={isOpen} onClose={handleClose} title="Edit Teacher" size="lg">
