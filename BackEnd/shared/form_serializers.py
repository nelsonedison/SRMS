...
class CustomFormSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = CustomForm
        fields = ['id', 'title', 'description', 'department', 'department_name', 'approval_workflow', 'is_active', 'fields', 'created_by_type', 'created_by_name', 'created_at']
...
class FormCreateSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = CustomForm
        fields = ['title', 'description', 'department', 'approval_workflow', 'fields']
...
class FormSubmissionSerializer(serializers.ModelSerializer):
    ...
    form_approval_workflow = serializers.CharField(source='form.approval_workflow', read_only=True)
    ...
    class Meta:
        ...
        fields = ['id', 'form', 'form_title', 'form_approval_workflow', 'student', 'student_name', 'student_college_id', 'data', 'status', 'submitted_at', 'reviewed_by_name', 'tutor_reviewed_by', 'tutor_reviewed_at', 'tutor_comments', 'hod_reviewed_by', 'hod_reviewed_at', 'hod_comments', 'principal_reviewed_by', 'principal_reviewed_at', 'principal_comments']
